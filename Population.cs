...
namespace MakeLand
{
    public class Population
    {
        ...
        public void mutate(Genotype g, Random r)
        {
            ...
            // arbitrarily choose this to be between 0 and 30 ; intuition is it should not be relatively too many genes that are mutated, but the tootal no. of genes is >= 300 usualy,i.e 10 % max.
            int num_mutates = toggleMutate * 3;
    ...
    public class Phenotype
    {
        ...
        public double landPercent = 0.0;
        public double seaPercent = 0.0;
        public double freshPercent = 0.0;
        ...
        public int setScore()
        {
            ...
            //Moved thexse initializations into the phenotype consructors
            //ouble landPercent = 0.0;
